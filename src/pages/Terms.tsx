  ...
  return (
    <Layout>
      ...
      <div className="container mx-auto py-10 px-4 sm:px-6 lg:px-8 max-w-4xl">
        <h1 className="text-3xl md:text-4xl font-bold mb-8 text-center">ViaFix Terms of Service</h1>
        
        <div className="prose prose-lg max-w-none">
          <p className="mb-4">Welcome to ViaFix.</p>
          ...
          <h2 className="text-2xl font-bold mt-8 mb-4">Key Terms</h2>
          
          <p className="mb-2">
            <strong>Clients</strong> are users who purchase services on ViaFix.
          </p>
          <p className="mb-2">
            <strong>Services</strong> are services offered by users registered on the site as Vendors through Gigs.
          </p>
          <p className="mb-4">
            <strong>Vendors</strong> are users who offer and perform services through Services listed on ViaFix.
          </p>
          
          <h2 className="text-2xl font-bold mt-8 mb-4">Role of ViaFix</h2>
          ...
          <h2 className="text-2xl font-bold mt-8 mb-4">Client Acknowledgements</h2>
          ...
          <h2 className="text-2xl font-bold mt-8 mb-4">Vendor Acknowledgements</h2>
          ...
          <ul className="list-disc pl-6 mb-6">
            ...
            <li className="mb-2">Orders that are removed for violations mentioned above, may result in the suspension of the Vendor's account.</li>
            <li className="mb-2">Orders that are removed for violations are not eligible to be restored or edited.</li>
            <li className="mb-2">Orders may be removed from our listings due to poor performance and/or user misconduct.</li>
            <li className="mb-2">Orders may include pre-approved website URLs contained within the Order description and requirements box. 
            Orders containing websites promoting content, which violates Our Terms of Service will be removed.</li>
            <li className="mb-2">Orders are required to have an appropriate Order image related to the service offered. 
            ...
            <li className="mb-2">Statements on the Order page that undermine or circumvent these Terms of Service are prohibited.</li>
            <li className="mb-2">ViaFix reserves the right to put any account on hold or permanently disable accounts due to breach of these Terms of Service, 
            including low quality services or deliveries, or due to any illegal or inappropriate use of the Site or services.</li>
            <li className="mb-2">Violation of the Terms of Service may get your account disabled permanently.</li>
            <li className="mb-2">Users with disabled accounts will not be able to sell or buy on ViaFix.</li>
          </ul>
          
          <h2 className="text-2xl font-bold mt-8 mb-4">Non-Permitted Usage</h2>
          
          <ul className="list-disc pl-6 mb-6">
            <li className="mb-2">
              <strong>Adult Services & Pornography</strong> - ViaFix does not allow any exchange of adult oriented or pornographic materials and services.
            </li>
            <li className="mb-2">
              <strong>Inappropriate Behavior & Language</strong> - Communication on ViaFix should be friendly, constructive, and professional. 
              ViaFix condemns bullying, harassment, and hate speech towards others.
            </li>
            <li className="mb-2">
              <strong>Phishing and Spam</strong> - Members' security is a top priority. Any attempts to publish or send malicious content with the intent to 
            ...
            <li className="mb-2">
              <strong>Privacy & Identity</strong> - You may not publish or post other people's private and confidential information. 
            ...
            <li className="mb-2">
              <strong>Authentic ViaFix Profile</strong> - You may not create a false identity on ViaFix, misrepresent your identity, 
