...
export const mechanicsDetailedData: Record<string, MechanicDetail> = {
  '1': {
    ...
    galleryImages: [
      ...
      'https://images.unsplash.com/photo-1503174971373-b1f69850bded?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80'
    ]
  },
  '2': {
    id: '2',
